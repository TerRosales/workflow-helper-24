...
export function FailedLoad() {
  return (
    <section className="h-[70vh] flex flex-col lg:h-[80vh] md:h-[90vh] sm:h-[95vh] px-6 space-x-5 max-w-2xl mx-auto text-center mb-5 justify-center items-center py-5">
      <span className="iconEmoji rounded-xl my-5">😢</span>
